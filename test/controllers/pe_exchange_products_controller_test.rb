...
class PeExchangeProductsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pe_exchange_product" do
    assert_difference('PeExchangeProduct.count') do
      post pe_exchange_products_url, params: { pe_exchange_product: { group_id: @pe_exchange_product.group_id, limit: @pe_exchange_product.limit, order: @pe_exchange_product.order, price: @pe_exchange_product.price, price_type: @pe_exchange_product.price_type, pe_product_id: @pe_exchange_product.pe_product_id, status: @pe_exchange_product.status } }
    end
  ...
  test "should update pe_exchange_product" do
    patch pe_exchange_product_url(@pe_exchange_product), params: { pe_exchange_product: { group_id: @pe_exchange_product.group_id, limit: @pe_exchange_product.limit, order: @pe_exchange_product.order, price: @pe_exchange_product.price, price_type: @pe_exchange_product.price_type, pe_product_id: @pe_exchange_product.pe_product_id, status: @pe_exchange_product.status } }
